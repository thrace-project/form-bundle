...
class DateRangePickerType extends AbstractType
{
    ...
    {
        $builder
            ->add($options['first_name'], 'thrace_datepicker', array_merge($options['options'], $options['first_options']))
            ->add($options['second_name'], 'thrace_datepicker', array_merge($options['options'], $options['second_options']))
        ;
    }
